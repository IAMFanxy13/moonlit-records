...
- A standalone correct Space event with only one authored bass pitch becomes an open bass gesture consisting of root, fifth, and octave. Auto-arranged standalone left-hand parts use a four-note open voicing, while explicitly authored multi-note left-hand voicings stay unchanged.
